...
public class PresentationDataServiceImpl implements PresentationDataService {
    ...
    public void createData() {
        ...
        manager.setPassword(argon2PasswordEncoder.encode("admin"));
        ...
        manager2.setPassword(argon2PasswordEncoder.encode("admin2"));
        ...
        musician.setPassword(argon2PasswordEncoder.encode("user"));
        ...
        musician2.setPassword(argon2PasswordEncoder.encode("user2"));
        ...
        musician3.setPassword(argon2PasswordEncoder.encode("user3"));
        ...
        musician6.setPassword(argon2PasswordEncoder.encode("roger"));
        ...
        musician7.setPassword(argon2PasswordEncoder.encode("brian"));
        ...
        musician8.setPassword(argon2PasswordEncoder.encode("john"));
